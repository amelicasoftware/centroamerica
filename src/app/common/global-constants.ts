export class GlobalConstants {
    ...
    public static serviciosURL: string = 'http://localhost:8080/centroamerica/';
    // public static serviciosURL: string = 'http://localhost:8080/BackEndAmelic-0.0.1-SNAPSHOT/centroamerica/';
