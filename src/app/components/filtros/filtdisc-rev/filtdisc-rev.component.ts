...
@Component({
  selector: 'app-filtdisc-rev',
  templateUrl: './filtdisc-rev.component.html',
  styleUrls: ['./filtdisc-rev.component.css']
})
export class FiltdiscRevComponent implements OnInit {
  ...
  ngOnInit(): void {
   this.revistasInyectado.getAreas().subscribe((revistasDesdeApi: any) => {
  ...
  applicarFiltros() {
    ...
    this.revistasInyectado.getBusquedaRevistaFiltroDisc(palabra, cadenaDisciplina, cadenaInstitucion, cadenaPais,
