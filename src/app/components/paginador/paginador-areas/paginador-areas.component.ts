...
@Component({
  selector: 'app-paginador-areas',
  templateUrl: './paginador-areas.component.html',
  styleUrls: ['./paginador-areas.component.css']
})
export class PaginadorAreasComponent implements OnInit {
  final: number;
  ...
  public ultimapagina(ultimapagina: number) {
    ...
    this.articulosService.getBusquedaArticulosPaginadorDisc(this.articulosService.getNumA(), this.paginadorService.pFinal).subscribe((data: any) => {
        console.log(data);
  ...
  public primerPagina() {
    ...
    this.articulosService.getBusquedaArticulosPaginadorDisc(this.articulosService.getNumA(), 1).subscribe((data: any) => {
      this.filtrosService.actualizarArticulos(data.articulos.articulos);
  ...
  public incCount() {
    ...
    this.articulosService.getBusquedaArticulosPaginadorDisc(this.articulosService.getNumA(), this.paginadorService.posicion).
      subscribe((data: any) => {
  ...
  public numerosPag(pagina: number, final: number) {
    ...
    this.filtrosService.actualizarPalabra(this.articulosService.getNumA())
    this.articulosService.getBusquedaArticulosPaginadorDisc(this.filtrosService.palabra , pagina).subscribe((data: any) => {
      this.filtrosService.actualizarArticulos(data.articulos.articulos);
      this.paginadorService.cambioloading(true)
    });
